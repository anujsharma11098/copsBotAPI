...
router.checkout('/:id', authAdmin, async (req, res) => {
    ...
    if (complaint.status === 0) {
        ...
        await SolvedComplaint.create({
            ...
            timeOfIncident: complaint.timeOfIncident,
...
router.put('/:id', authSuperAdmin, async (req, res) => {
    try {
        ...
        await Complaint.create({
            ...
            crimeCategory: foundFakeComplaint.crimeCategory,
            ...
            landmark: foundFakeComplaint.landmark,
            dateOfIncident: foundFakeComplaint.dateOfIncident,
            timeOfIncident: foundFakeComplaint.timeOfIncident,
